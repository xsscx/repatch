...
##                 https://color.org
#
# Last Modified: 19-JAN-2026 1800Z by David Hoyt
# Intent: Windows PR-498 Build Script
#
#
# iex (iwr -Uri "https://raw.githubusercontent.com/InternationalColorConsortium/iccDEV/refs/heads/research/contrib/HelperScripts/pr498.ps1").Content
#
#
#
###############################################################

Write-Host "============================= Starting Windows Build for PR-498 =============================" -ForegroundColor Green
Write-Host "Last Updated: 19-JAN-2026 1500Z by David H Hoyt LLC" -ForegroundColor Green
