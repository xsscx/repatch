...
##                 https://color.org
#
# Last Modified: 07-DEC-2025 1300Z by David Hoyt
# Intent:Runtime Check for header-guards branch
#
...
#
# https://github.com/InternationalColorConsortium/iccDEV/pull/249
#
# Run: bash -c "$(curl -fsSL https://raw.githubusercontent.com/InternationalColorConsortium/iccDEV/refs/heads/research/contrib/HelperScripts/issue299.sh)"
#
#
###############################################################
...
echo ""
echo "===================== iccDEV | PR249 Runtime Template ====================="
...
echo ""
            set +e
            echo "========= Start Version 2.3.1.1 ========="
            iccFromXml
            cd ..
            set -e
            echo "========= Stop Version Check =========="
echo ""
echo "======================================================"
echo "===================  ISSUE STOP   ===================="
echo "======================================================"
