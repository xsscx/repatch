...
# Intent:Runtime Check for PR249
#
...
#
# Run: bash -c "$(curl -fsSL https://raw.githubusercontent.com/InternationalColorConsortium/iccDEV/refs/heads/research/contrib/HelperScripts/pr308.sh)"
#
#
###############################################################
...
echo ""
echo "===================== iccDEV | PR308 Unix Runtime Template ====================="
