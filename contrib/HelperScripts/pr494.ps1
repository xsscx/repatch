...
# Intent: Windows PR-494 Build Script
#
#
# iex (iwr -Uri "https://raw.githubusercontent.com/InternationalColorConsortium/iccDEV/refs/heads/research/contrib/HelperScripts/pr494.ps1").Content
#
#
#
###############################################################

Write-Host "============================= Starting Windows Build for PR-494 =============================" -ForegroundColor Green
Write-Host "Last Updated: 19-JAN-2026 1500Z by David H Hoyt LLC" -ForegroundColor Green
git clone https://github.com/InternationalColorConsortium/iccDEV.git
cd iccDEV
git fetch origin pull/494/head:pr-494
git checkout pr-494
