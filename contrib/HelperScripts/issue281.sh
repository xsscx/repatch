...
##                 https://color.org
#
# Last Modified: 02-DEC-2025 1700Z by David Hoyt
...
#
#
# Run: /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/InternationalColorConsortium/iccDEV/refs/heads/research/contrib/HelperScripts/issue281.sh)"
#
#
###############################################################
